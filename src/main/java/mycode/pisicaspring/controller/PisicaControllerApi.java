...
public interface PisicaControllerApi {
    ...
    List<PisicaNumeVarstaDto> getPisiciMaiBatrane(@PathVariable int varstaMinima,
    ...
    PisicaRasaListRequest getRaseUnice(@ParameterObject @PageableDefault(size = 10) Pageable pageable);
    ...
    PisicaVarstaRangeListRequest getPisiciByVarstaRange(@RequestParam int min,
    ...
    PisicaListRequest getOrderedByVarsta(@ParameterObject @PageableDefault(size = 10) Pageable pageable);
    ...
    PisicaNumeRasaListRequest getByNumePrefix(@PathVariable String prefix,
                                               @ParameterObject @PageableDefault(size = 10) Pageable pageable);
    ...
    RasaAverageAgeListRequest getAverageAgeByRasa(@ParameterObject @PageableDefault(size = 10) Pageable pageable);
}
